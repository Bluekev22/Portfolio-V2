...
function Home() {
    return (
        ...
        <Grid container item lg={9} spacing={2} alignItems="center" justifyContent="center"> 
            ...
            <Grid item className="about-me">I am tirelessly seeking out more knowledge so that I can integrate it into my designs. I love the process of coming up with a solution, brainstorming, researching thoroughly, and finally, sculpting those answers into a design that I can be proud of.</Grid>
        </Grid>
        <Grid item lg={3}>
        <Headshot />
